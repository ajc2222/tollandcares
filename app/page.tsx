...
export default function Home(){
 ...
 return <main>
  ...
  <section ref={section} className={`story ${staticMode?"static":""}`} aria-label="Care takes many forms"><div className="stage">
   ...
   <div className="film-footer"><span>{staticMode?"A community built on kindness":!loaded?"Preparing the story…":"Scroll to see care in motion ↓"}</span></div><div className="timeline" aria-hidden="true"><div style={{width:`${time/15.04*100}%`}}/></div>
  </div></section>
